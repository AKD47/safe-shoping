...
* http://jqueryui.com
* Includes: widget.js, position.js, data.js, disable-selection.js, focusable.js, form-reset-mixin.js, jquery-1-7.js, keycode.js, labels.js, scroll-parent.js, tabbable.js, unique-id.js, widgets/mouse.js, widgets/slider.js, effect.js, effects/effect-blind.js, effects/effect-bounce.js, effects/effect-drop.js, effects/effect-explode.js, effects/effect-fade.js, effects/effect-fold.js, effects/effect-highlight.js, effects/effect-puff.js, effects/effect-pulsate.js, effects/effect-scale.js, effects/effect-shake.js, effects/effect-size.js, effects/effect-slide.js, effects/effect-transfer.js
...
(function($) {
	$.fn.countdown = function(options, callback) {
		...
		function countdown_proc() {
			...
			//conditional Ss
			if (days == 1) { thisEl.find(".timeRefDays").text("дни"); } else { thisEl.find(".timeRefDays").text("дни"); }
			if (hours == 1) { thisEl.find(".timeRefHours").text("часы"); } else { thisEl.find(".timeRefHours").text("часы"); }
			if (minutes == 1) { thisEl.find(".timeRefMinutes").text("минуты"); } else { thisEl.find(".timeRefMinutes").text("минуты"); }
